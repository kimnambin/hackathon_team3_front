...
const Blue2 = () => {
    ...
    const testData = [
        { number: 7, text: '모든 일들이 힘들게 느껴진다.' },
        { number: 8, text: '앞 일이 암담하게 느껴진다.' },
        { number: 9, text: '지금까지의 내 인생은 실패작이라는 생각이 든다.' },
    ];
...
<div className={styles.topText}>
        ...
        <div>
            <div className={styles.testpart2}>
                ...
                <p>적어도 보통 사람들만큼의 능력은 있었다고 생각한다.</p>
            </div>
        ...
        <button className={styles.nextPage} onClick={goToBlue}>
