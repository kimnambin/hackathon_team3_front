...
export default function Profile() {
    ...
    const clickIcon = () => setIcon(prev => !prev);
    ...
    return (
        <div className={styles.Profile_container}>
           ...
           <img className={styles.Profile_top03_img} src='data:image/png;base64,' alt=''>
            ...
            :
             <img className={styles.Profile_top03_img} src='data:image/png;base64,' alt=''>
            </img>
                }
                </span>
